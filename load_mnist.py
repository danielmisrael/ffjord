...
parser.add_argument("--resume", type=str, default='/home/ray/Documents/ffjord/experiments/cnf/mnist_ffjord_50.pth')
...
def load_ffjord_mnist():
    ...
    return model.to('cuda'), train_loader
